...
char2.style.right="10px";

char2.addEventListener("mouseenter",function(){
    char2.style.WebkitTransform = "rotate(20deg)";
});
char2.addEventListener("mouseleave",function(){
    char2.style.WebkitTransform = "rotate(0deg)";
});
